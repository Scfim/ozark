...
import {addSubCategory,editSubCategory,deleteSubCategory} from '../api/subCategory'
    ...
    return (
        <div id="categorie" className={`w-full flex ${state}`}>
            <div className={`flex flex-col  `}>
                <label htmlFor="" className={`text-xl font-bold my-1`}>Ajouter une nouvelle sous catégorie</label>
